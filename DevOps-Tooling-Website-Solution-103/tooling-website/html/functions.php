...
$db = mysqli_connect('127.0.0.1', '172.31.8.112', 'webaccess', 'admin', 'admin', 'tooling');

// Database connection settings
$db_host = '172.31.8.112'; // Replace with your database private IP
$db_user = 'webaccess';         // Replace with your database username
$db_pass = 'Password';          // Replace with your database password
$db_name = 'tooling';        // Replace with your database name
